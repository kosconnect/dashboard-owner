    ...
    container.innerHTML += `
        <div class="card">
            ...
            <div class="card-content">
                ...
                <h3>Aksi</h3>
                <button class="btn btn-lihat"onclick="location.href='manajemen_kamar_kos.html?boarding_house_id=${boarding_house_id}')><i class="fas fa-eye"></i>Lihat Kamar Kos</button>
